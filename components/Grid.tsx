    ...
    <div className="mt-[75px]">
      <div className="">
        ...
        <p className="text-2xl">
          Listed below are some of my featured websites projects, all currently
          a<span className="underline px-1">work in progress.</span>
          These websites are being built to assist...
        </p>
        {/* //*GRID STARTS HERE */}
        <div
          id="website-grid"
          className="grid grid-cols-1 gap-x-4 gap-y-16 mt-5"
        >
